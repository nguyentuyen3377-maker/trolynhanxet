...
<div class="header-box">
    ...
    <p>Tác giả: Nguyễn Văn Tuyên - Trường PTDTBT TH Ngam La</p>
</div>
""", unsafe_allow_html=True)
...
# --- FOOTER ---
st.markdown("<div style='text-align:center; margin-top:50px; color:#888;'>© 2026 - Thầy Tuyên Tool</div>", unsafe_allow_html=True)
